...
- Please have a look over the sibling project [server-sslibev](https://github.com/samuelhbne/vpn-launchpad/tree/master/server-trojan) if you'd like to set a Shadowsocks server.
