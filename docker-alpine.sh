...
docker build --build-arg DKUID="$DKUID" --build-arg DKGID="$DKGID" -f docker-vpnlaunchpad/Dockerfile --rm=true -t samuelhbne/vpnlaunchpad:alpine docker-vpnlaunchpad/
